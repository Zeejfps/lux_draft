<script lang="ts">
  ...
  import { moduleEntitySummary } from '../floorplan/stores/moduleActivation';
  import {
    propertiesPanelConfig,
    togglePropertiesPanel,
  } from '../floorplan/stores/propertiesPanelStore';
  import FloatingPanel from '../floorplan/ui/FloatingPanel.svelte';
  import type { EditorDocument, PropertiesPanelConfig } from '../floorplan/types';
...
>
  <div class="property-section">
    ...
    {#if $moduleEntitySummary}
      <div class="property-row info">
        <span>{$moduleEntitySummary.label}</span>
        <span class="light-count">{$moduleEntitySummary.count}</span>
      </div>
    {/if}
    <div class="property-row info">
      <span>Doors</span>
