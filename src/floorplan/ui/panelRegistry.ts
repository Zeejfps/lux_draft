...
import type { PanelComponent } from '../types/moduleRuntime';
...
/** Idempotent — the activation scope owns the unregister, and disposal may run twice. */
export function unregisterPanel(panelKey: string): void {
